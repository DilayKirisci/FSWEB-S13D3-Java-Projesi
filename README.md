...
### com.workintech.model.Wall Sınıfı

* ```com.workintech.model.Wall``` isimli bir sınıf tanımlayınız.
* Sınıf için 2 tane ```instance variable``` tanımlayınız.
* Bu iki sınıf değişkeni; ```width``` double olmalı, ```height``` double olmalı.
* com.workintech.model.Wall sınıfı için bir adet ```constructor``` tanımlayınız. 2 parametreyi de set etmeli.
* com.workintech.model.Wall sınıfı içerisine 5 tane metod ekleyiniz.
